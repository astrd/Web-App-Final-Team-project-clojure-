...
var G__2360 = o;
(G__2360[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__2366 = jsprops;
(G__2366["defaultValue"] = value);

(G__2366["onChange"] = ((function (G__2366,v,value,on_change){
return (function (p1__2365_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__2365_SHARP_);
});})(G__2366,v,value,on_change))
);
...
var vec__2369 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2369,(0),null);
var id = cljs.core.nth.call(null,vec__2369,(1),null);
var class$ = cljs.core.nth.call(null,vec__2369,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___2373 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___2373 == null)){
} else {
var key_2374 = temp__5461__auto___2373;
(jsprops["key"] = key_2374);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__2375 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__2375["name"] = c);
...
args__4502__auto__.push((arguments[i__4500__auto___2381]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq2378){
var G__2379 = cljs.core.first.call(null,seq2378);
var seq2378__$1 = cljs.core.next.call(null,seq2378);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2379,seq2378__$1);
});
...
break;
default:
var G__2385 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__2385;
continue;
...
var n__4376__auto___2387 = a.length;
var i_2388 = (0);
while(true){
if((i_2388 < n__4376__auto___2387)){
(a[i_2388] = reagent.impl.template.as_element.call(null,(a[i_2388])));

var G__2389 = (i_2388 + (1));
i_2388 = G__2389;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___2390 = a.length;
var i_2391 = (0);
while(true){
if((i_2391 < n__4376__auto___2390)){
var val_2392 = (a[i_2391]);
if(((cljs.core.vector_QMARK_.call(null,val_2392)) && ((reagent.impl.template.key_from_vec.call(null,val_2392) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_2391] = reagent.impl.template.as_element.call(null,val_2392));

var G__2393 = (i_2391 + (1));
i_2391 = G__2393;
continue;
} else {
}
...
var ctx = ({});
var vec__2394 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__2394,(0),null);
var derefed = cljs.core.nth.call(null,vec__2394,(1),null);
...
var G__2397 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2397) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__2397){
...
//# sourceMappingURL=template.js.map?rel=1542213427617
